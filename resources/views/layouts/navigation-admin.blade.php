<nav x-data="{ open: false }" class="bg-[#004CBE] border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center justify-center flex-1">
                ...
                <div class="hidden space-x-8 sm:flex">
                    ...
                    {{-- Gestionar Usuarios: Alumnos, Docentes y Administradores --}}
                    ...
                    {{-- Administrar: Campus, Facultades y Ternas --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
     ...
     <!-- GESTIONAR USUARIOS: ALUMNOS, DOCENTES Y ADMINISTRADORES -->       
            ...
            <!-- ADMINISTRAR: CAMPUS, FACULTADES Y  --> 
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-white">{{ strtoupper(Auth::user()->name) }}</div>
